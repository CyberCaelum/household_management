...
public class RocketMQConstant {
     ...
     * 消息主题-每日服务自动确认超时
     */
    public static final String DAILY_CONFIRM_TIMEOUT_TOPIC = "DAILY_CONFIRM_TIMEOUT_TOPIC";
    /**
     * 消息标签-每日服务自动确认处理
     */
    public static final String DAILY_CONFIRM_TIMEOUT_TAG = "DAILY_CONFIRM_TIMEOUT";
}
